...
use crate::StdErr;
use crate::db::Db;
use crate::models::{Board, Card, BoardSummary, CreateBoard, CreateCard, UpdateCard, Token};
...
impl FromRequest for Token {
    ...
    // - ready later (pending on a SQL query that validate the request's Bearer token)
