...
use crate::models::{Board, Card, Status, BoardSummary, CreateBoard, CreateCard, UpdateCard, Token};
use crate::StdErr;
...
impl Db {
    ...
    pub async fn create_card(&self, create_card: CreateCard) -> Result<Card, StdErr> {
        let card = sqlx::query_as("INSERT INTO cards (board_id, description) VALUES ($1, $2) RETURNING *")
